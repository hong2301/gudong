<template>
  <view class="overture" :style="{ height: `${headHeight}px` }">
    <view
      class="capsule-box"
      :style="{
        width: `${capsuleBoxWitdh - capsuleWidth - capsuleRightInterval}px`,
...
// 胶囊宽度
const capsuleWidth = ref<number>(uni.getMenuButtonBoundingClientRect().width);
// 胶囊右间隔
